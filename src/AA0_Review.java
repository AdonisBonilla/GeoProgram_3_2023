public class AA0_Review extends World {
    ...
    public void go() {
        ...
        plane.setColor(110, 47, 8);
        plane.move(sizeoftree);
        plane.move(50);// Uses the move method to move forward 50, since line 13 set sizeoftree to 50
